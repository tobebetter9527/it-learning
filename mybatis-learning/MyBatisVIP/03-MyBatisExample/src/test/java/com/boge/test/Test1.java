...
public class Test1 {
    ...
    public void test1() throws Exception {
        ...
        List<User> list = mapper.selectUserList(null);
    ...
    public void test2() throws Exception {
        ...
        // 测试清除一级缓存
        user.setUserName("just for test change name");
        ...
        user2.setUserName("just for test change name");
        mapper2.updateById(user2);

        User user3 = mapper2.selectUserById(param);
    ...
    public void test4() throws Exception {
        ...
        List<User> user = mapper.selectUserList(query);
        System.out.println(user);
    ...
    public void test5() throws Exception {
        ...
        List<User> users = mapper.selectUserList(null);
