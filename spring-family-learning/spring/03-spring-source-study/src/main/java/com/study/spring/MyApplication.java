...
public class MyApplication {
	...
	public static void main(String[] args) {
		...
		// 注解的方式
		ApplicationContext context2 = new AnnotationConfigApplicationContext(MyApplication.class);
		...
		new ClassPathBeanDefinitionScanner(context3).scan("com.study.spring.service");
		// 一定要刷新
		context3.refresh();
